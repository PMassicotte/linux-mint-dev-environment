...
```bash
./configure --enable-R-shlib --enable-threads=posix --with-cairo --with-libpng --with-libtiff --with-jpeglib --with-lapack --with-blas="-fopenmp -m64 -I/opt/intel/compilers_and_libraries_2020.4.304/linux/mkl/include -L/opt/intel/compilers_and_libraries_2020.4.304/linux/mkl/lib/intel64 -lmkl_gf_lp64 -lmkl_gnu_thread -lmkl_core -lpthread -lm"

./configure --enable-R-shlib --enable-threads=posix --with-cairo --with-libpng --with-libtiff --with-jpeglib --with-lapack --with-blas="-fopenmp -m64 -I$MKLROOT/include -L$MKLROOT/lib/intel64 -lmkl_gf_lp64 -lmkl_gnu_thread -lmkl_core -lpthread -lm" --libdir=/usr/bin
